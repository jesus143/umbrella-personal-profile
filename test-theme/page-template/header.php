...
<script defer src="<?php bloginfo('stylesheet_directory'); ?>/slider/js/demo.js"></script>
	...
	<script type="text/javascript">
		...
		$( document ).ready( function() {
			...
			$('.btn-login').click(function(e){ console.log('login popup');
				$('.modal').show();
				$('.modal-dialog').css({
					'position' : 'absolute',
					'left' : '50%',
...
<div id="home-content">
<?php if(!is_user_logged_in()){ ?>
<div class="modal" id="modal-one" aria-hidden="true" style="display:block;">
	 <div class="modal-dialog">
		...
		<div class="modal-body">
			<div class="modal-body-left" style="width: 100% !important;">
				<ul class="tab">
				...
				<div style="display:block;" class="tabcontent"  id="Login">
					<div class="log"></div>
						<div id="popup-custom-login-form">
						<?php
						echo do_shortcode("[login_page style='fullwidth' forgotpw='false' width='320px' bgcolor='#ffffff' textcolor='#333333' usernametext='Email Address' passwordtext='Password' buttontext='Login to Your Support Centre >>' inputfieldsize='medium' buttonsize='medium' buttonfontsize='13px' buttonbgcolor='#d7090a' buttontextcolor='#ffffff' buttonbordercolor='transparent']");
						?>
						</div>
						<script type="text/javascript">
							$(window).on('load', function(){
							  var errMsg = $('#page-area').find('.login_box').length;
							  if(errMsg > 0) {
							    var msg = $('#page-area').find('.login_box').detach();
							    $('#popup-custom-login-form > div[class^="op-login-form"]').prepend(msg); console.log('appended');
							  }
							});
						</script>
					...
					<div class="modal-body-right">
						<h3>Sign in with</h3>
						 <?php
							...
							// $loginUrl = $helper->getLoginUrl('https://testing.umbrellasupport.co.uk', $permissions);
				...
				<div style="" class="tabcontent" id="SignUp" style="width: 98% !important;">
